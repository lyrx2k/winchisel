pub fn t(key: &str) -> &'static str {
    match key {
        ...
        "extras" => "Extras",
        "extras_title" => "Extras",
        "extras_subtitle" => "Reserved for additional tools and utilities",
        "extras_loading" => "Loading extras...",
        "extras_brave_label" => "Brave Browser - Debloat",
        "extras_brave_desc" => "Toggle Brave policy debloat on or off.",
        "extras_brave_enabled_desc" => "Brave debloat policies are enabled.",
        "extras_brave_disabled_desc" => "Brave debloat policies are disabled.",
        "extras_edge_label" => "Microsoft Edge - Debloat",
        "extras_edge_desc" => "Toggle Microsoft Edge policy debloat on or off.",
        "extras_widgets_label" => "Widgets - Remove",
        "extras_widgets_desc" => "Remove the taskbar widgets package and restore it on demand.",
        "extras_ctfmon_label" => "Stop CTFMON from intercepting",
        "extras_ctfmon_desc" => "Disable the input service values that can intercept CTFMON.",
        ...
        "extras_teredo_desc" => "Disable Teredo tunneling for lower latency on some networks.",
        "extras_ps7_label" => "PowerShell 7 Telemetry - Disable",
        "extras_ps7_desc" => "Disable PowerShell 7 telemetry on this machine.",
        ...
        "extras_power_plan_apply" => "Apply",
        "extras_power_plan_applied" => "Winchisel power plan applied successfully.",
        "extras_brave_on_applied" => "Brave debloat enabled.",
        "extras_brave_off_applied" => "Brave debloat disabled.",
        ...
        "repair_window" => "System Repair",
        "repair_desc" => "Runs DISM and SFC to check and repair Windows component corruption",
        "repair_run" => "Run Repair",
        "repair_running" => "Repair running...",
        "repair_running_desc" => "This can take a while. Keep the window open until it finishes.",
        "repair_log_title" => "Live log",
        "repair_log_waiting" => "Waiting for output...",
        "repair_stage_dism" => "Running DISM /Online /Cleanup-Image /RestoreHealth",
        "repair_stage_sfc" => "Running sfc /scannow",
        "repair_success" => "System repair finished successfully.",
        "repair_failed" => "System repair failed",
        "repair_failed_run" => "Failed to start the repair command.",
        "repair_failed_windows" => "System repair is only supported on Windows.",
